...
export const FAST_TRACK_BOARD: FastTrackTile[] = [
  ...
  { index: 1, kind: 'investment', id: 'software', name: 'Software company', nameTh: 'บริษัทซอฟต์แวร์', cost: 200000, downPayment: 50000, cashFlow: 20000 },
  { index: 2, kind: 'dream', id: 'orphanage' },
  { index: 3, kind: 'investment', id: 'pizza', name: 'Pizza franchise (10)', nameTh: 'แฟรนไชส์พิซซ่า 10 สาขา', cost: 100000, downPayment: 25000, cashFlow: 10000 },
  { index: 4, kind: 'charity' },
  { index: 5, kind: 'investment', id: 'apartments', name: 'Apartment complex', nameTh: 'อาคารอพาร์ตเมนต์', cost: 150000, downPayment: 40000, cashFlow: 15000 },
  { index: 6, kind: 'dream', id: 'island' },
  { index: 7, kind: 'cashflowDay' },
  { index: 8, kind: 'investment', id: 'carwash', name: 'Car wash chain', nameTh: 'เครือร้านล้างรถ', cost: 80000, downPayment: 20000, cashFlow: 8000 },
  ...
  { index: 11, kind: 'investment', id: 'goldmine', name: 'Gold mine', nameTh: 'เหมืองทอง', cost: 120000, downPayment: 30000, cashFlow: 12000 },
  { index: 12, kind: 'cashflowDay' },
  { index: 13, kind: 'investment', id: 'tvstation', name: 'TV station', nameTh: 'สถานีโทรทัศน์', cost: 250000, downPayment: 60000, cashFlow: 25000 },
  { index: 14, kind: 'dream', id: 'mediterranean' },
  { index: 15, kind: 'charity' },
  { index: 16, kind: 'investment', id: 'hotel', name: 'Resort hotel', nameTh: 'โรงแรมรีสอร์ต', cost: 175000, downPayment: 45000, cashFlow: 17500 },
  { index: 17, kind: 'dream', id: 'politics' },
  { index: 18, kind: 'cashflowDay' },
  { index: 19, kind: 'investment', id: 'oilwells', name: 'Oil wells', nameTh: 'บ่อน้ำมัน', cost: 90000, downPayment: 25000, cashFlow: 9000 },
  ...
  { index: 22, kind: 'investment', id: 'shoppingmall', name: 'Shopping mall', nameTh: 'ศูนย์การค้า', cost: 220000, downPayment: 55000, cashFlow: 22000 },
  { index: 23, kind: 'cashflowDay' },
  { index: 24, kind: 'investment', id: 'airline', name: 'Regional airline', nameTh: 'สายการบินภูมิภาค', cost: 300000, downPayment: 75000, cashFlow: 30000 },
  { index: 25, kind: 'dream', id: 'space' },
  { index: 26, kind: 'charity' },
  { index: 27, kind: 'investment', id: 'brewery', name: 'Craft brewery', nameTh: 'โรงเบียร์คราฟต์', cost: 110000, downPayment: 30000, cashFlow: 11000 },
  { index: 28, kind: 'dream', id: 'foundation' },
  { index: 29, kind: 'cashflowDay' },
  { index: 30, kind: 'investment', id: 'datacenter', name: 'Data center', nameTh: 'ศูนย์ข้อมูล', cost: 260000, downPayment: 65000, cashFlow: 26000 },
